...
abstract class Operation implements FatherExpression {
    protected final String TypeOFOperation;
    protected FatherExpression left;
    protected FatherExpression right;

    public Operation(FatherExpression l, FatherExpression r, String t) {
    ...
    public Operation(FatherExpression l, FatherExpression r, char t) {
        this.TypeOFOperation = String.valueOf(t);
        this.left = l;
        this.right = r;
    }

    public Operation(FatherExpression arg, String t) {
        this.TypeOFOperation = t;
        this.left = arg;
    }
