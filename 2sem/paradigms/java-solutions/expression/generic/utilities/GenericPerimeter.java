...
public class GenericPerimeter<T extends Number> extends GenericBinaryOperation<T> {
    private final TypeForCalculate<T> type;

    public GenericPerimeter(GenericExpression<T> l, GenericExpression<T> r, TypeForCalculate<T> type) {
        super(l, r, '+');
        this.type = type;
    }
